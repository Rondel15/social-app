            ...
            <div className="relative">
              ...
              {coverPreview && (
                <button
                  ...
                  className="absolute top-2 right-2 w-7 h-7 rounded-full bg-black/60 hover:bg-red-500 flex items-center justify-center text-white transition-colors"
                >
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-shrink-0">
                <div
                  className="w-20 h-20 rounded-full bg-accent flex items-center justify-center text-white text-2xl font-medium overflow-hidden relative cursor-pointer group"
...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="pt-14">
        {/* Cover */}
        <div className="h-40 bg-gradient-to-r from-accent/30 to-purple-900/30 relative z-0">
        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="flex items-end justify-between -mt-12 mb-4">
            {/* Avatar */}
            <div className="w-24 h-24 rounded-full border-4 border-surface bg-accent flex items-center justify-center text-white text-3xl font-medium overflow-hidden relative z-10">
